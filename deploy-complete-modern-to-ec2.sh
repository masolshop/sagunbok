...
# 사근복 AI - 완전한 모던 디자인 EC2 배포 스크립트
# 배포 날짜: 2026-01-21
# 배포 파일: dist-complete-modern-20260121154525.tar.gz
...
# 배포 정보
DEPLOY_FILE="dist-complete-modern-20260121154525.tar.gz"
...
# 헤더 출력
echo -e "${PURPLE}╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${PURPLE}║${NC}  ${BOLD}🚀 사근복 AI - 완전한 모던 디자인 EC2 배포${NC}          ${PURPLE}║${NC}"
echo -e "${PURPLE}╠══════════════════════════════════════════════════════════╣${NC}"
...
BACKUP_NAME="html.backup.complete-modern.$(date +%Y%m%d%H%M%S)"
...
# [5/7] 완전한 모던 디자인 배포
echo -e "${CYAN}[5/7]${NC} ${BOLD}완전한 모던 디자인 배포 중...${NC}"
$SSH_CMD ${EC2_USER}@${EC2_HOST} "
    cd /tmp
    tar -xzf ${DEPLOY_FILE}
...
# 완료 메시지
echo -e "${PURPLE}╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${PURPLE}║${NC}  ${BOLD}${GREEN}🎉 완전한 모던 디자인 배포 완료!${NC}                   ${PURPLE}║${NC}"
echo -e "${PURPLE}╠══════════════════════════════════════════════════════════╣${NC}"
echo -e "${PURPLE}║${NC}  ${BOLD}배포 URL:${NC} ${CYAN}http://${EC2_HOST}/${NC}"
echo -e "${PURPLE}║${NC}  ${BOLD}백업 위치:${NC} ${YELLOW}/var/www/${BACKUP_NAME}${NC}"
echo -e "${PURPLE}║${NC}"
echo -e "${PURPLE}║${NC}  ${BOLD}새로운 기능:${NC}"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} 로그인 페이지 - 모던 디자인"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} 회원가입 페이지 - 모던 디자인 (기업/컨설턴트)"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} ID 찾기 페이지 - 모던 디자인"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} 비밀번호 찾기 페이지 - 모던 디자인"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} 배경 애니메이션 (3색 블롭)"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} 글래스모피즘 효과"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} 멀티 그라데이션"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} 이모지 아이콘"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} 호버/포커스 애니메이션"
echo -e "${PURPLE}║${NC}  ${GREEN}✓${NC} 로딩 스피너"
echo -e "${PURPLE}║${NC}"
echo -e "${PURPLE}║${NC}  ${BOLD}테스트 계정:${NC}"
echo -e "${PURPLE}║${NC}  ${CYAN}기업회원:${NC} ID: 010-1234-5678 (가입된 전화번호)"
echo -e "${PURPLE}║${NC}             PW: (설정한 비밀번호)"
echo -e "${PURPLE}║${NC}  ${CYAN}컨설턴트:${NC} ID: 010-8765-4321 (가입된 전화번호)"
